...
public class BlockPlanks extends Block implements IMetaName
{
	...
	public BlockPlanks(String name)
	{
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.RESIN));
