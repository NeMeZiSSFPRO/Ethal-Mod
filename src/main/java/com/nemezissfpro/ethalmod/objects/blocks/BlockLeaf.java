...
public class BlockLeaf extends BlockLeaves implements IMetaName
{
	...
	public BlockLeaf(String name) 
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.RESIN).withProperty(CHECK_DECAY, Boolean.valueOf(true)).withProperty(DECAYABLE, Boolean.valueOf(true)));
